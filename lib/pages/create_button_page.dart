...
class CreateButtonPage extends StatefulWidget {
  const CreateButtonPage({super.key});

  @override
  State<CreateButtonPage> createState() => _CreateButtonPageState();
}

class _CreateButtonPageState extends State<CreateButtonPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      title: const Text('Criar Botão', style: TextStyle(color: Colors.white),),
